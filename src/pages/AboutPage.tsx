...
export const AboutPage = () => (
  <div className="min-h-screen pt-24 bg-white fade-in">
    <div className="max-w-[1920px] mx-auto px-6 md:px-12">
      <div className="py-12 border-b border-gray-200 mb-12">
         <h1 className="text-6xl md:text-9xl font-display font-bold text-[#1A2B48] opacity-10 uppercase">Philosophy</h1>
         <div className="mt-[-40px] md:mt-[-80px] ml-2 md:ml-4">
      ...
      <div className="grid md:grid-cols-3 gap-0 border-t border-gray-200">
         {[
           ...
           <div key={idx} className="p-12 border-r border-b border-gray-200 hover:bg-[#1A2B48] group transition-colors duration-500">
    ...
    <div className="bg-white py-24 border-t border-gray-200 text-[#1A2B48]">
      <div className="max-w-[1920px] mx-auto px-6 md:px-12">
         ...
         <div className="flex flex-col-reverse lg:flex-row gap-6 mb-12">
            <div className="lg:w-1/3 border border-[#D1D5DB] rounded-xl p-8 lg:p-12 flex items-center justify-center gap-8 bg-gray-50">
               <div className="text-2xl font-bold leading-snug tracking-widest">
                  神經牽拉<br/>效應
               </div>
         ...
         <div className="mb-32">
            <h3 className="text-3xl font-bold text-center mb-16 tracking-widest">健康脊椎自己矯，四大功能</h3>
            ...
            <p className="mt-16 text-center text-[#4B5563] max-w-4xl mx-auto leading-relaxed">
               讓脊椎回到原廠設定，舒緩各種疼痛，恢復身體的自動修復功能，讓各種症狀得到改善，期待盡快能幫助您遠離身體痛苦，回復脊椎原廠設定，讓身心健康、延年益壽！
            </p>
         </div>

         <div>
            <h3 className="text-3xl font-bold text-center mb-6 tracking-widest">健康脊椎、自我調理三步驟</h3>
            <p className="text-center text-[#4B5563] mb-16 leading-relaxed">
